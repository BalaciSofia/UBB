...
public class ProgramState {
    private final MyStackI<Statement> exeStack;
        ...
        private MyBarrierI barrierTable;
        public final static Lock barrierLock = new ReentrantLock();

    public ProgramState(MyStackI<Statement> stk, MyDictionaryI<String, Value> symtbl, MyListI<Value> ot,
                        MyDictionaryI<String, BufferedReader> fileTable, MyHeapI heap, MyBarrierI barrierTable){
        this.exeStack = stk;
        this.table = symtbl;
        this.output = ot;
    ...
    public MyBarrierI getBarrierTable(){

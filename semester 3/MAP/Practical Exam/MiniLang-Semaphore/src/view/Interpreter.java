...
public class Interpreter {
    ...
    public Controller createProgram(Statement s,String filename){
        ...
        MySemaphoreTableI semaphoreTable = new MySemaphoreTable();
        exeStack1.push(s);
        ProgramState programState1 = new ProgramState(exeStack1, symTable1, out1, fileTable1,heap,semaphoreTable);

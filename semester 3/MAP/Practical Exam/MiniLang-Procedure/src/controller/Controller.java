...
public class Controller {
    ...
    public void garbageCollector(ProgramState state) throws DictException, StackException {
        MyDictionaryI<String,Value> table=state. getSymTableStack().peek();
    ...
    public void conservativeGarbageCollector(List<ProgramState> states) throws DictException, StackException {

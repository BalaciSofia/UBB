...
public class Interpreter {
    ...
    public Controller createProgram(Statement s,String filename){
        ...
        MyStackI<MyDictionaryI<String,Value>> symtablestack1= new MyStack<>();
        symtablestack1.push(new MyDictionary<>());
        MyListI<Value> out1 = new MyList<>();
        MyDictionaryI<String, BufferedReader> fileTable1 = new MyDictionary<>();
        MyHeapI heap=new MyHeap();
        ProceduresTable procedureTable=new ProceduresTable();
        exeStack1.push(s);
        ProgramState programState1 = new ProgramState(exeStack1, symtablestack1, out1, fileTable1,heap, procedureTable);

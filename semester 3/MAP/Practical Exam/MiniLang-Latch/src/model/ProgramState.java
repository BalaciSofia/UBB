...
public class ProgramState {
    private final MyStackI<Statement> exeStack;
        ...
        private MyLatchTableI latchTable;
        public final static Lock latchLock=new ReentrantLock();

    public ProgramState(MyStackI<Statement> stk, MyDictionaryI<String, Value> symtbl, MyListI<Value> ot,
                        MyDictionaryI<String, BufferedReader> fileTable, MyHeapI heap, MyLatchTableI latchTable){
        this.exeStack = stk;
        this.table = symtbl;
        this.output = ot;
    ...
    public MyLatchTableI getLatchTable(){
